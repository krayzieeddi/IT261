...
// register php
// config.php 
// credentials.php -- your private database credentials (DB Name, Username, PW and Host)
// errors.php 
// register.php -- basic registration form
// login.php  -- basic login form
// server.php
// header.php
// styles.css
// index.php -- our home page!
